...
public class MeleeAttackStats
{
    ...
    public ImpaleAttackStats? Impale { get; set; }
...
public sealed class MeleeAttack
{
    ...
    public MeleeDamagePacket[] LastDamagePackets { get; private set; } = [];
    ...
    {
        Attack(player, slot, mainHand, out terrainCollisions, out entitiesCollisions, new(), AttackDirection.Top);
    }
    ...
    private void ApplyImpaleStats(MeleeDamagePacket packet, ItemSlot slot)
    {
        ...
        packet.ImpaleTargetFilter = Impale.TargetFilter;
        packet.ImpaleMaxTargetVolume = Impale.MaxTargetVolume;
        packet.ImpaleHoldOffset = Impale.HoldOffset;
        packet.ImpaleTargetOffset = Impale.TargetOffset;
        packet.ImpaleThrowVelocity = Impale.ThrowVelocity;
        packet.ImpaleThrowUpBias = Impale.ThrowUpBias;
    }
}
